...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FileUpload = function (_React$Component) {
	    ...
	    _createClass(FileUpload, [{
	        ...
	        key: 'forwardClearFiles',
	        value: function forwardClearFiles() {
	            this.refs['ajax_upload_file_input'].value = '';
	        }
	        ...
	        value: function _packRender() {
	            ...
	            if (this.isIE) {
	                ...
	                render = _react2.default.createElement(
	                    'div',
	                    { className: me.props.className, style: me.props.style },
	                    me.state.before,
	                    _react2.default.createElement(
	                        'div',
	                        { onClick: me.commonChooseFile.bind(me),
	                            style: { overflow: 'hidden', postion: 'relative', display: me.wrapperDisplay }
	                        },
	                        me.state.chooseBtn
	                    ),
	                    me.state.middle,
	                    _react2.default.createElement(
	                        'div',
	                        { onClick: me.commonUpload.bind(me),
	                            style: {
	                                overflow: 'hidden',
	                                postion: 'relative',
	                                display: me.chooseAndUpload ? 'none' : me.wrapperDisplay
	                            }
	                        },
	                        me.state.uploadBtn
	                    ),
	                    ...
	                    _react2.default.createElement('input', _extends({ type: 'file', name: 'ajax_upload_file_input', ref: 'ajax_upload_file_input',
	                        style: { display: 'none' }, onChange: me.commonChange.bind(me)
	                    }, restAttrs))
	                );
	            }
	            return render;
